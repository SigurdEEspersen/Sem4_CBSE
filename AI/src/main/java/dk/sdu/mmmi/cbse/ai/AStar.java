...
public class AStar implements IAI {
   ...
   public void addAdjacentMiddleRow(Node currentNode) {
    ...
    @Override
   public void addAdjacentUpperRow(Node currentNode) {
        int row = currentNode.getRow();
        int col = currentNode.getCol();
        int upperRow = row - 1;
        if (upperRow >= 0) {
    ...
    @Override
   public void checkNode(Node currentNode, int col, int row, int cost) {
   ...
   public boolean isFinalNode(Node currentNode) {
    ...
    @Override
   public boolean isEmpty(PriorityQueue<Node> openList) {
